...
function wifiHotspotChange() {
    const val = document.getElementById('wifi-mambo').value;
    const wrap = document.getElementById('wifi-identificador-wrap');

    // Mostra campo de identificador somente para Mambo
    wrap.style.display = val === 'mambo' ? 'block' : 'none';
    if (val !== 'mambo') document.getElementById('wifi-identificador').value = '';

    // Regra de VLANs por opcao:
    // Nao    -> todas menos vlan20
    // Wifeed -> todas (vlan20 criada, mas sem address hotspot)
    // Mambo  -> todas incluindo vlan20 com address
    const comVlan20 = (val === 'wifeed' || val === 'mambo');
    document.getElementById('vlan20').checked = comVlan20;
    document.getElementById('vlan30').checked = true;
    document.getElementById('vlan40').checked = true;
    document.getElementById('vlan50').checked = true;
    document.getElementById('vlan60').checked = true;
}

function wifiLimpar() {
    document.getElementById('wifi-ap').value = 'tplink';
    document.getElementById('wifi-mambo').value = 'nao';
    document.getElementById('wifi-identificador').value = '';
    document.getElementById('wifi-identificador-wrap').style.display = 'none';

    // Padrao 'Nao': todas as VLANs menos a 20
    document.getElementById('vlan20').checked = false;
    document.getElementById('vlan30').checked = true;
    document.getElementById('vlan40').checked = true;
    document.getElementById('vlan50').checked = true;
    document.getElementById('vlan60').checked = true;

    document.getElementById('wifi-resultado').style.display = 'none';
...
function wifiGerar() {
    ...
    const hotspot = document.getElementById('wifi-mambo').value; // 'nao' | 'wifeed' | 'mambo'
